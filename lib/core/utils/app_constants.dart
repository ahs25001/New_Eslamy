...
List<Widget> onBoardingPages = [
  OnBoardingPage(
    imagePath: AppPathies.onBoarding1,
    title: "Welcome To Islami App",
    massage: "",
  ),
  OnBoardingPage(
    imagePath: AppPathies.onBoarding2,
    title: "Welcome To Islami App",
    massage: "We Are Very Excited To Have You In Our Community",
  ),
  OnBoardingPage(
    imagePath: AppPathies.onBoarding3,
    title: "Reading the Quran",
    massage: "Read, and your Lord is the Most Generous",
  ),
  OnBoardingPage(
    imagePath: AppPathies.onBoarding4,
    title: "Bearish",
    massage: "Praise the name of your Lord, the Most High",
  ),
  OnBoardingPage(
    imagePath: AppPathies.onBoarding5,
    title: "Holy Quran Radio",
    massage: "You can listen to the Holy Quran Radio through the application for free and easily",
  ),
];
